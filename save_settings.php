...
$section_title = addslashes(str_replace($friendly, $raw, trim($_POST['section_title'])));
$section_description = addslashes(str_replace($friendly, $raw, trim($_POST['section_description'])));
...
$picture_dir = addslashes(trim($_POST['picture_dir']));

$header = addslashes(str_replace($friendly, $raw, $_POST['header']));
$topics_loop = addslashes(str_replace($friendly, $raw, $_POST['topics_loop']));
$footer = addslashes(str_replace($friendly, $raw, $_POST['footer']));


$topic_header = addslashes(str_replace($friendly, $raw, $_POST['topic_header']));
$topic_footer = addslashes(str_replace($friendly, $raw, $_POST['topic_footer']));
$topic_block2 = addslashes(str_replace($friendly, $raw, $_POST['topic_block2']));

$pnsa_string = 	addslashes(str_replace($friendly, $raw, $_POST['pnsa_string']));
$sa_string = addslashes(str_replace($friendly, $raw, $_POST['sa_string']));
/*
...
$pnsa_max = addslashes($_POST['pnsa_max']);


$commenting = addslashes($_POST['commenting']);
$default_link = addslashes($_POST['default_link']);
$use_captcha = addslashes($_POST['use_captcha']);
$sort_comments = addslashes($_POST['sort_comments']);
...
$is_master_for = addslashes(trim($_POST['is_master_for']));
