...
<!-- Header -->
';
$topics_loop = '<div class="mod_topic_loop mod_topic_active[ACTIVE] mod_topic_comments[COMMENTSCLASS]">
{THUMB}
...
$topic_header = '<div class="mod_topic_page">
...
<hr/>
';
$topic_block2 = '<!--see help how to use a second block -->
...
$pnsa_string = '<p style="margin-top:5px; clear:left;">
...
$comments_header = '<h2>Kommentare</h2>
';

$comments_loop = '<blockquote class="mod_topic_commentbox">
